...
$headers   .= 'Content-type: text/html; charset=utf-8' . "\r\n";
	...
	$sucMsg = "<br/><br/><br/><br/>Mail sent successfully.";
...
<body class="fraim">
<form method="post" action="" id="frmEnquiry" name="frmEnquiry" style="margin:0">
  <input type="hidden" value="<?php echo $link;?>" name="link" id="link"  />
  <div class="crew_top">
    <?php if($sucMsg!="") { ?>
    <h3 align="center" style="padding-bottom:20px; color:#FFF;" > <?php if($sucMsg) { echo $sucMsg."<br/>";}?> </h3>
    <?php } else { ?>
