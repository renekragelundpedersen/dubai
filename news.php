...
$sqlNews = "SELECT * FROM news_master WHERE is_active = 'Y' ORDER BY added_on DESC";
                ...
                <ul>
                  ...
                  { 
...

                    {
                        ...
                        $fldnews_photo = stripslashes($newsItem['news_photo']);
                	...
                	<li>
                    	...
                    	<div class="list_images">
                           ...
                           { 
                                    ...
                                    $srcNews =$siteURL."timthumb/scripts/timthumb.php?src=".$FRONT_NEWS_IMGPATH.$fldnews_photo."&w=226&h=154&zc=1";

                           ?> 

                

                           <a href="<?php echo SERVER_URL.'news-details.php?nid='.$newsItem['slug']?>&par=news"><img src="<?php echo $srcNews; ?>" border="0" ></a>
                        ...
                        <div class="list_content">
                        	...
                        	<h4><a style="background:none; padding:0px;" href="<?php echo SERVER_URL.'news-details.php?nid='.$newsItem['slug']?>&par=news"><?php echo stripcslashes($newsItem['news_title'])?></a></h4>

                            <p><?php echo wordLimiter(stripslashes(strip_tags($newsItem['news_content'])),50);?></p>

             				<a href="<?php echo SERVER_URL.'news-details.php?nid='.$newsItem['slug']?>&par=news">Read more</a>
