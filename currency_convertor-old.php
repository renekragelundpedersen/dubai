...
?>
    ...
    <input class="field1" type="text" id="prop_price" value="<?php echo $fldproperty_price?>" name="prop_price" style="color:#1F3157;"/> <span style="margin-left:5px; padding:10px 0 0 0; font-weight:bold;">AED</span></dt>
