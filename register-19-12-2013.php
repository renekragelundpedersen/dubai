...
<body class="fraim">
<a id="lig" onclick="window.parent.SexyLightbox.display('images/msg.jpg'); return false;"></a>
<form method="post" action="" id="register_form" name="register_form" style="margin:0">
  <div class="crew_top">
    ...
    <h3 align="center" style="color:#FFF;"><?php if($sucMsg) { echo $sucMsg."<br/>";}  ?></h3>
    <?php } else { ?>
    ...
    <dl>
      ...
      <dt>
        <label>Address: </label>
        <textarea id="address" name="address" class="" style="height:35px;"><?php echo $address?></textarea>
      </dt>
      <dt>
      ...
      <dt>
        ...
        <textarea id="msg" name="msg" class="required" style="height:55px;"><?php echo $msg?></textarea>
      </dt>
      <dt>
        ...
        <input name="txt_code" id="txt_code" type="text" value="" class="required field2" />
