...
<div id="wrapper">
  ...
  <!--section header -->
  <!--section banner -->
  <section id="inside"><img src="<?php if($rowContent[0]['page_photo3']!="") {echo $srcBan;} else { ?><?php echo $siteURL ?>images/inner_banner.jpg<?php } ?>">
    ...
    <div class="inc_left">
      ...
      <div class="breadcrumbs">
        <ul>
          ...
          <li><a class="bread_active">404 Page not found</a></li>
        </ul>
        <div class="bread_mail"> <a class="br_mail" href="email.php?TB_iframe=true&height=550&width=307"rel="sexylightbox">Email</a> </div>
      </div>
      <div class="page">
        <p><img src="<?php echo $siteURL; ?>/images/404.jpg" style="width:680px; float:left;" /></p>
      </div>
    </div>
