...
function pagination_seven2($total_pages,$page,$get_query_str,$siteURL,$type){
	...
	if($webpage='search_result.php')

	{

	$webpage='search_result.html';

	}

	

  	$qstr = explode('&',$get_query_str);
...
//	if($qstr2[0] == 'propfor'||$qstr2[0] == 'propFor')
...
//	}
    ...
    if($total_pages!=1){
        ...
        if($page>'1'){
            ...
            $pagination.= '<li class="next"><a class="next" href="'.$siteURL.$search.$qstring.'1/'.$webpage.'">'.$lang["first"].'</a></li>

                           <li class="next"><a class="next" href="'.$siteURL.$search.$qstring.($page-1).'/'.$webpage.'">'.$lang["prev"].'</a></li>
        ...
        //echo $i.'<br>';
			...
			//echo $siteURL;
                ...
                $pagination.= '<li><a href="'.$siteURL.$search.$qstring.$i.'/'.$webpage.'">'.$i.'</a>
        ...
        if(($page >='1')&&($page!=$total_pages)){
            ...
            $pagination.= '<li class="next"><a class="next" href="'.$siteURL.$search.$qstring.($page+1).'/'.$webpage.'">'.$lang["next"].'</a></li>

                           <li class="next"><a class="next" href="'.$siteURL.$search.$qstring.$total_pages.'/'.$webpage.'">'.$lang["last"].'</a></li>
