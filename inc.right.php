<div class="inc_right">
  <div class="register_ad"><a href="register.php?TB_iframe=true&height=290&width=500" rel="sexylightbox"><img src="<?php echo $siteURL ?>images/register-now-inner.png" alt=""></a></div>
  ...
  <div class="property_listing">
    ...
    <ul>
      <?php
					...
					$sqlIm1 = "SELECT * FROM property_image_master WHERE prop_ref_id = '$propid' and display_order='1'";
					$rowIm1 = $obj->select($sqlIm1);
					$coun=count($rowIm1);
					if($coun>0)
					{
					$sqlIm = "SELECT * FROM property_image_master WHERE prop_ref_id = '$propid' and display_order='1'";
