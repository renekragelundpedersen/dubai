...
<!--section header-->
    ...
    <section id="banner">
    	...
    	<div id="container" class="clearfix">
            <div id="slideshow" class="clearfix">	
                ...
                ?>
                       <a href="#" rel="bookmark" >
                           <img src="<?php echo $srcBan; ?>" alt="<?php echo $TITLE; ?>"  /> </a>
                <?php
				}
				?>
                   </div>
    ...
    <div class="featurd_list">
    	<ul>
        	<li><a href="<?php echo $siteURL; ?>sell-property.php"><img src="images/listur.jpg"><p>List your property with us</p></a></li>
            <li><a href="<?php echo $siteURL; ?>sell-valuation.php"><img src="images/property.jpg"><p>property valuation services</p></a></li>
            <li><a href="<?php echo $siteURL; ?>content.php?content=open-house-calendar"><img src="images/open.jpg"><p>open house calendar</p></a></li>
        </ul>
    </div>
     <!--featurd_list -->
     <!--section slider-->
             ...
             <div class="tab-container2">
                    <div  id="tab3" class="tab-content2">                    
                        <div class="sliding">        	
                          <ul id="mycarousel" class="jcarousel-skin-tango">
								...
								?>                          
                              	<li>
                                  	<a href="<?php echo $siteURL; ?>details.php?pid=<?php echo $rowRen['slug']; ?>">
                                        <?php
										...
										?>
                                    <img src="<?php echo $srcRen; ?>" alt="" width="304" height="268" />
                                    </a>
                                 	<span>
                                    	<h2>AED <?php echo number_format($priceRen,0,'',','); ?><?php if($rowRen['prop_for_id']=='rent') { echo " / ".$rowRen['period']; } ?> </h2>
                    ...
                    <div class="sliding">        	
                           <ul id="mycarousel2" class="jcarousel-skin-tango">
								...
								?>                 
                                <li>
                                  	<a href="<?php echo $siteURL; ?>details.php?pid=<?php echo $rowSal['slug']; ?>">
                                        <?php
										if($rowImg[0]['image_name']!="")
										{
										...
										?>
                                    <img src="<?php echo $srcSal; ?>" alt="" width="304" height="268" />
                                    </a>
                                 	<span>
                                    	<h2>AED <?php echo number_format($priceSal,0,'',','); ?><?php if($rowSal['prop_for_id']=='rent') { echo " / ".$rowSal['period']; } ?> </h2>
     ...
     <div class="about">
		...
		?>
        <a href="<?php echo $siteURL; ?>content.php?content=<?php echo $rowAbt[0]['slug']; ?>">Read more</a>
     </div>
     <!--section footer-->
     <?php
