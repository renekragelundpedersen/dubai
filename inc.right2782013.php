<div class="inc_right">
        	<div class="property_add">
            	<a href="<?php echo $siteURL; ?>sell-property.php"> <img src="images/click_here.jpg" onMouseOver="this.src='images/click_here_hvr.jpg'" onMouseOut="this.src='images/click_here.jpg'"></a>
            </div>
            <?php
            ...
            <div class="property_listing">
                ...
                <ul>
                    ...
                    ?>
                	<li>
                        <a href="<?php echo $siteURL; ?>details.php?pid=<?php echo $rowFea['slug']; ?>"><img src="<?php echo $rowIm[0]['image_name']; ?>" width="76" height="56"></a>
                        <a href="<?php echo $siteURL; ?>details.php?pid=<?php echo $rowFea['slug']; ?>"><h3>AED <?php echo number_format($price3,0,'',','); ?></h3></a>
            ...
            <a href="<?php echo $siteURL; ?>content.php?content=open-house-calendar"> <img src="images/click_open.jpg" onMouseOver="this.src='images/click_open_hvr.jpg'" onMouseOut="this.src='images/click_open.jpg'"></a>
            </div>
        </div>