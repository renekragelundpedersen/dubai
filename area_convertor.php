...
?>
    ...
    <input type="text" id="prop_total_area" readonly="readonly" class="field1" value="<?=currency_format($fldproperty_area)?>" name="prop_total_area" style="color:#1F3157;"/> <span style="margin-left:6px; padding:0;">Sq.ft</span></dt>
	<dt>
    	<label for="yeid" style="color:#1F3157; padding-top:10px;">Convert</label>
    ...
    <p style="float:left; margin:0; padding:0; color:#1F3157; font-size:14px;"><strong><?=$fldproperty_area_val?></strong></p>
    </dt>
</dl>
</form>
</div>
