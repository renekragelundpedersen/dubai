...
$key = get_param('txtKey') ? get_param('txtKey')  : get_session('txtKey') ;
$type = get_param('type') ? get_param('type')  : get_session('type') ;//$_REQUEST['type'];
$community = get_param('community') ? get_param('community')  : get_session('community') ;//$_REQUEST['community'];
$page2 = get_param('page2') ? get_param('page2')  : get_session('page2') ;//$_REQUEST['page2'];
$range =get_param('range') ? get_param('range')  : get_session('range') ;// $_REQUEST['range'];
...
if($tab==1)
{
	$priceRent = get_param('priceRent') ? get_param('priceRent')  : get_session('priceRent');//$_REQUEST['priceRent'];
...
if($tab==2)
{
	$priceSale = get_param('priceSale') ? get_param('priceSale')  : get_session('priceSale');//$_REQUEST['priceSale'];
...
if($key!="Your Keyword here" && $key!='')
{
	$sqlQry .= "(c.city_name LIKE '%$key%' OR d.name LIKE '%$key%' OR p.prop_name LIKE '%$key% ) AND ";
