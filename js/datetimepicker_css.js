...
var SpanBgColor = "#648b9c"; //span background color
var MonthYearColor = "#ffffff"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#73644f"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#cfd0ce"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#dedfdd"; //Background color of Saturday.
...
var HoverColor = "#e79d2c"; //color when mouse move over.
var DisableColor = "#999966"; //color of disabled cell.
var CalBgColor = "#648b9c"; //Background color of Calendar window.
