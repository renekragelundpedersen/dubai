...
var gBegin=[2007,11,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
...
var giFirstDOW=6;	// indicates the first day of week. 0:Sunday; 1-6:Monday-Saturday.
