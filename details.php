...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=xa-5128961741ab164f"></script>
            ...
            <div id="details_main">
              ...
              <div class="details_lightbox">
                  <ul>
                     ...
                     <li><a class="currency" rel="sexylightbox" href="<?php echo $siteURL; ?>mor_calc/mortgage_calculator.htm?TB_iframe=true&amp;height=405&amp;width=650">Mortgage Calculator</a></li>
             ...
             <div class="property_details">
             	<ul>
                    ...
                    <li>
                                <?php
								if($rowBed2[0]['bed_val']!="")
								{
								if($rowBed2[0]['bed_val']!="0")
								{
								?>
                    	<a href="" class="bedroom"><?php echo $rowBed2[0]['bed_val']; ?> Bedroom</a>
                                <?php
								}
								}
								?>
               ...
               <!-- <ul style="width:330px; margin-left:20px;">
                ...
                <ul style="width:330px; margin-left:20px;">
                	<h3>Contact Details</h3>
                	<li><label style="width:54px;">Agent:</label> <span><?php echo $rowQry[0]['agent_name']; ?></span></li>
                    <li><label style="width:54px;">Mobile:</label> <span><?php echo $rowQry[0]['agent_phone']; ?></span></li>
                    <li><label style="width:54px;">Email:</label>
                    <a href="mailto:<?php echo $rowQry[0]['agent_email']; ?>" style="text-decoration:underline;"><?php echo $rowQry[0]['agent_email']; ?></a></li>
                </ul>
                   <?php
				   }
				   else
                ...
                <p><!--<a rel="sexylightbox" href="<?php echo $siteURL; ?>make-offer.php?ref=<?php echo $rowQry[0]['prop_ref_no']; ?>&agent=<?php echo $rowQry[0]['prop_agent_id']; ?>&price=<?php echo $price; ?>&TB_iframe=true&height=550&width=660"><img src="images/make_an_offer.jpg" 
                    ...
                    <a rel="sexylightbox" href="<?php echo $siteURL; ?>make-enquiry.php?propid=<?php echo $propid; ?>&agent=<?php echo $rowQry[0]['prop_agent_id']; ?>&ref=<?php echo $rowQry[0]['prop_ref_no']; ?>&TB_iframe=true&height=390&width=590"><img src="images/enguiry.jpg" onMouseOver="this.src='images/enguiry_hvr.jpg'"
            ...
            <h3>Facilities</h3>
            	<div class="facilities">
                  ...
                  <div id="map_canvas" style="width: 724px; height: 400px;float:left; margin:0px; padding:0px;"></div>
