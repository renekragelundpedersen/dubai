...
$news = $obj->select("SELECT * FROM news_master WHERE slug ='$pid'");
...
<title><?php echo $news[0]['news_title']; ?> - <?php echo $TITLE; ?></title>

<meta name="desription" content= "<?php echo $news[0]['news_title']; ?> - <?php echo $DESC; ?>"/>

<meta name="keywords" content="<?php echo $news[0]['news_title']; ?> - <?php echo $KEY; ?>"/>
     	...
     	<div class="inc_left">
            ...
            <div class="breadcrumbs">
            	...
            	<ul>                    
                	...
                	<li><a class="bread_active" href="<?php echo $siteURL; ?>news.php">News</a></li>

                    <li><a class="bread_active"><?=stripslashes($news['0']['news_title'])?></a></li>
...
<ul class="newsdetails">
          ...
          <li style="background:none">
            ...
            <h2><?=stripslashes($news['0']['news_title'])?></h2><span><?php echo $date; ?></span>

            <?php if($news[0]['news_photo']) 

			{ 

					$srcNews =$siteURL."timthumb/scripts/timthumb.php?src=".$FRONT_NEWS_IMGPATH.$news[0]['news_photo']."&w=350&h=225&zc=1";

			?>

            <span class="im"><img src="<?php echo $srcNews; ?>" border="0" >

            </span><?php } ?>

            <a style="width:100%; padding-top:15px; float:left;" href="javascript:history.back();"><img src="images/back.jpg"></a> 

            <p><?=stripslashes($news['0']['news_content'])?></p>
