            ...
            <div id="details_main">
              ...
              <div class="details_lightbox">
                  <ul>
                     ...
                     <li><a class="area" rel="sexylightbox" href="<?php echo $siteURL; ?>currency_convertor.php?propprice=<?php echo $price; ?>&amp;?TB_iframe=true&amp;height=350&amp;width=350">Currency Converter</a></li>
