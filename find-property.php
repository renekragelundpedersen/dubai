...
if($_POST)
{
 	 ...
 	 {
  	$sql_enq="insert into enquiry_master(property_id,name,email,mobile,phone,agent_id,status, 	budget_range,prop_bed,message,location)values('$refno','$fullname','$email','$mobile','$telephone','$fldagent_name','O','$fldproperty_price1','$beds','$txtMsg','$country')";
	...
	$message ='<body style="border:solid 0px #4a4a4a; width:592px;color:#000;"><table style="margin:0 auto; padding:0px;
				...
				<br/><b>Budget Price :</b>'.$fldproperty_price1.' AED
				...
				<br/><b>Telephone :</b>'.$telephone.'<br/>
				  ...
				  <tr style="background-color:#ccc;"><td style="width:592px; height:29px; float:left" >&copy; Copyright '.date('Y').' One Real Estate Properties. All rights reserved.
				  </td>
				  </tr>
				</table></body>';
...
if($msg==1)
    ...
    <div class="crew_top" style="margin-top:10px; width:600px;">
                        ...
                        <div style="width:560px; float:left; padding:10px; margin-top:15px; font-size:12px; border:1px dashed #93e095;">
    
    <dl style="width:48%;">
    	<dt>
        	<label>Type your budget: <img src="<?php echo $siteURL ?>images/mandatory.gif" alt="mandatory" /></label>
    ...
    <br />
        ...
        <select name="txtBeds" id="cmb_area_type" class="required" style="height:28px;">
          <option value="">Select Type</option>
          <?php echo FillListBox2("bedrooms","bed_val",$txtBeds,"bed_val"," WHERE is_active='Y' ORDER BY bed_val",$db);?>
        </select>
       </dt>                 
                            <dt class="flast">
                            	<label>Verification Code: <img src="<?php echo $siteURL ?>images/mandatory.gif" alt="mandatory" /></label>
                  ...
                  <input class="required field2" type="text" name="txtCode" id="txtCode" value=""/>                                    
                            	...
                            	<input type="image"  onmouseout="this.src = 'images/send_but.png';" onmouseover="this.src = 'images/send_but_hvr.png';" src="images/send_but.png" id="butSer" name="butSer" class="save_but">  
                            </dt>             
        ...
        <label for="name">Property<img src="<?php echo $siteURL ?>images/mandatory.gif" alt="mandatory" /></label>
             <select name="txtProperty" style="height:28px;" class="required">
